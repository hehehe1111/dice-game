...
if(randomNumber1 > randomNumber2){
  document.querySelector(".container").innerText = "player 1 wins";
}
else if (randomNumber1 < randomNumber2){
  document.querySelector(".container").innerText = "player 2 wins";
}
else document.querySelector(".container").innerText = "Draw";
